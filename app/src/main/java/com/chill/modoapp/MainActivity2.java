...
public class MainActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pillList.add(new Pill("Omega 3", 0, "With breakfast", 6, "9:00 AM"));
        pillList.add(new Pill("Aspirin", 0, "None", 15, "3:00 PM"));
        pillList.add(new Pill("Vitamin B12", 0, "With lunch", 8, "12:00 PM"));
        pillList.add(new Pill("Lexapro", 0, "Before bed", 10, "9:00 PM"));
